...
export const TOOLS: ToolDef[] = [
  ...
  // ── Intelligence query tool ────────────────────────────────────────────────
  {
    ...
    inputSchema: z.object({
      ...
      depth: z.number().int().positive().optional().describe("Traversal depth limit (find_call_chain, find_data_path, find_transitive_dependencies, find_long_functions, find_import_cycles_deep)"),
